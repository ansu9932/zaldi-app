  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1, backgroundColor: colors.primary }}>
      <View style={[styles.wrap, { paddingTop: insets.top + 80 }]}>
        <Text style={styles.logo}>next<Text style={{ color: colors.ink }}>.</Text></Text>
        <Text style={styles.sub}>Delivery Partner Login</Text>
...
const styles = StyleSheet.create({
  ...
  sub: { color: 'rgba(255,255,255,0.85)', fontSize: 14, marginTop: 4, marginBottom: 32, fontWeight: '600' },
